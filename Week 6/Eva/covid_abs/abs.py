...
class Simulation(object):
    ...
    def create_agent(self, status, infectiousness):
        ...
        self.population.append(Agent(x=x, y=y, age=age, status=status, infected_status=infectiousness, social_stratum=social_stratum))
    ...
    def contact(self, agent1, agent2):
        ...
        ## incubation period
        if agent1.status == Status.Susceptible and agent2.status == Status.Infected and agent2.infected_status == InfectionSeverity.Infectious:
